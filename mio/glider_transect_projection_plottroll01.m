...
FS1=12; % label
XLIM = [0 m_lldist([origin(2) target(2)], [origin(1) target(1)],1)];
...
xlim(XLIM)
ylim([0 zMax])
text(2,300, 'T (^{\circ}C)  (A)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
cb = colorbar;
adjust_space
pause(1)
...
text(2,300, 'S_A (g Kg^{-1})  (B)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold', 'color',[1 1 1]*0)
adjust_space
pause(1)
...
ylim([0 zMax])
cb = colorbar;
text(2,300, '[Chl-a] (\mug L^{-1})  (D)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
adjust_space
pause(1)
...
%xlabel('Along-transect distace (km)', 'FontSize', 10, 'fontWeight', 'bold')
cb = colorbar;
text(2,300, '[Naph-like] (RU)  (e)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
%text(2,300, '[Naph-like] (RU)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
xlabel('Along-transect distace (km)', 'FontSize', 10, 'fontWeight', 'bold')
cb = colorbar;
text(2,300, '[CDOM] (\mug L^{-1})  (G)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
%xlabel('Along-transect distace (km)', 'FontSize', 10, 'fontWeight', 'bold')
cb = colorbar;
text(2,300, '[Phe-like] (RU)  (f)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
%text(2,300, '[Phe-like] (RU)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
text(2,300, 'log_{10}(BB700)  (H)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
text(2,300, 'log_{10}(N^2 (s^{-2}))  (C)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
ylim([0 zMax])
cb = colorbar;
text(2,300, 'O_2 (\mumol Kg^{-1})  (I)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold', 'color',[1 1 1]*0)
...
!montage M312_T_noplot.png M312_S_noplot.png M312_O2_noplot.png M312_CHL_noplot.png M312_TRY_noplot.png M312_PHE_noplot.png M312_CDOM_noplot.png M312_BB_noplot.png -tile 2x4  -geometry 740x390+1+1  M312_noplots.png 