...
xlim(XLIM)
ylim([0 zMax])
text(XLIM(1)+2,600, 'T (^{\circ}C)  (A)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
cb = colorbar;
adjust_space
pause(1)
...
text(XLIM(1)+2,600, 'S_A (g Kg^{-1})  (B)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold', 'color',[1 1 1]*0)
adjust_space
pause(1)
...
ylim([0 zMax])
cb = colorbar;
text(XLIM(1)+2,600, '[Chl-a] (\mug L^{-1})  (D)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
adjust_space
pause(1)
...
ylim([0 zMax])
cb = colorbar;
text(XLIM(1)+2,600, '[Naph-like] (RU)  (e)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
xlabel('Along-transect distace (km)', 'FontSize', 10, 'fontWeight', 'bold')
cb = colorbar;
text(XLIM(1)+2,600, '[CDOM] (\mug L^{-1})  (G)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
ylim([0 zMax])
cb = colorbar;
text(XLIM(1)+2,600, '[Phe-like] (RU)  (f)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
text(XLIM(1)+2,600, 'log_{10}(BB700)  (H)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
text(XLIM(1)+2,600, 'log_{10}(N^2 (s^{-2}))  (C)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold')
...
ylim([0 zMax])
cb = colorbar;
text(XLIM(1)+2,600, 'O_2 (\mumol Kg^{-1})  (I)', 'horizontalAlignment', 'left', 'fontSize', FS1, 'fontWeight', 'bold', 'color',[1 1 1]*0)
