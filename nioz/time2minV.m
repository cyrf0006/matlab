function time2maxV = time2minV(adcpFile, timeVec)
...
%
% Should modify to include a switch between max/min
...
Vitp = interp1(timeAdcp, Ufilt, timeVec);
...
for i = 1:length(timeVec)
    [Y,I] = min(abs(timeVec(i)-timeMin));
    time2maxV(i) = timeVec(i)-timeMin(I);
end
