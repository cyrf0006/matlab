...
%% get bathym transect
% $$$ m_line([-16.17, -15.43]+.058,[55.820, 55.023],'color','m','linewi',1,'linestyle', '--'); 
...
%[range,ln,lt]=m_lldist([-16, -15.5],[55.820, 55.023], 1000); %'m'
...
dlmwrite('RockalBathym.dat', transect ,'delimiter',' ','precision',12) 
...
% $$$     m_line(lonVec(i), latVec(i), 'marker', '.', 'color', 'm','markersize',12);
% $$$ end
% $$$ 
% $$$ 
% $$$ theta = 30;
...
%save figure
print('-dpng', '-r300', 'RockallMap_noZoom_rectangle.png')
