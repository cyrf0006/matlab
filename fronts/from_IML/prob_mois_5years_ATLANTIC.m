...
% chacun des mois, moyennée sur 5 ans (2006-2010)
...
monthly_prob_5years=zeros(dim_im(1),dim_im(2)); % création de la matrice de probabilités de détection de fronts pour les 5 ans

extension  = 'mat';
used_files5=0; %compteurs de fichiers utilisés; pour validation doit être = 5 (1 mois * 5 ans) 
