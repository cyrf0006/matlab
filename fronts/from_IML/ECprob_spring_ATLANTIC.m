...
%
%  Ce script créer UNE matrice de probabilité de présence de fronts POUR 
%  LE PRINTEMPS DE CHACUNE des années traitées

function [prob_season,cumul_prob,used_files3] = ECprob_spring_ATLANTIC(year)
...
prob_season=zeros(dim_im(1),dim_im(2)); % création de la matrice de probabilités de détection de fronts pour la saison

extension  = 'mat';
used_files3=0; %compteurs de fichiers utilisés; pour validation doit être = à 3 (3 mois * 1 ans) 
